...
class MessageProcessingTest(TestCase):
    ...
    def setUp(self):
        ...
        self.address = "somerecipient@someaddress.com"
        self.fromaddr = "somesender@someaddress.com"
        self.message = "This is a message here"
        models.db.session.add(models.Mailbox(address=self.address))
    ...
    def test_incoming_message(self):
        send_mail(self.fromaddr, [self.address, "blap@bloop.com"], self.message)
