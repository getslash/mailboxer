...
if __name__ == "__main__":
    ...
    if tag is not None:
        ...
        subprocess.check_call(f'docker tag getslash/mailboxer:testing getslash/mailboxer:{tag}', shell=True)
        subprocess.check_call(f'docker push getslash/mailboxer:{tag}', shell=True)
    else:
